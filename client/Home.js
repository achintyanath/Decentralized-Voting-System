...
function Home(props) {
  ...
  useEffect(async () => {
    ...
    try {
      // Get network provider and web3_instance instance.
      const web3_instance = await getWeb3();

      // Use web3_instance to get the user's accounts.
      ...
      // Set web3_instance, accounts, and contract to the state, and then proceed with an
